...
/* ============================================================
 * K_right experiment (mirrors src/pivco_huffman_bu_x86.c).
 * Sidecar precompute + variant decoder that reads from kr_arr
 * instead of running popcount_K_right at each internal node.
 * Used by extras/bench_kr to measure the upper-bound win.
 * ============================================================ */
